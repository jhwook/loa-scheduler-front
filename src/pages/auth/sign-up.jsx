...
export function SignUp() {
  ...
  useEffect(() => {
    setIsMatch(confirmPassword === password);
        ...
        <form className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2">
          <div className="mb-1 flex flex-col gap-6">
            ...
            <div>
              ...
              />
              {!isMatch && (
                <Typography variant="small" className="mt-1 ml-1 text-red-400 font-medium">
                  비밀번호가 일치하지 않습니다.
                </Typography>
              )}
            </div>
          ...
          <Button
            ...
            style={{
              cursor:
                !isMatch || !username || !password || !confirmPassword ? "not-allowed" : "pointer",
            }}
          >
            Register Now
          </Button>
