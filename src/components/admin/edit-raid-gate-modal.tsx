...
export function EditRaidGateModal({
  open,
  gate,
  pending,
  onClose,
  ...
  return (
    <div className="modal modal-open">
      <div className="modal-box max-w-2xl bg-base-200 text-base-content">
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-3">
          <input
            ...
            onChange={(e) =>
              setState((p) => (p ? { ...p, difficulty: e.target.value } : p))
            }
            placeholder="난이도"
          />
          <input
            ...
            onChange={(e) =>
              setState((p) =>
                p ? { ...p, gateNumber: Number(e.target.value) } : p
              )
            }
            placeholder="관문 번호"
          />
          <input
            ...
            onChange={(e) =>
              setState((p) => (p ? { ...p, gateName: e.target.value } : p))
            }
            placeholder="관문명"
          />
          <input
            ...
            onChange={(e) =>
              setState((p) =>
                p ? { ...p, minItemLevel: Number(e.target.value) } : p
              )
            }
          ...
          <input
            ...
            onChange={(e) =>
              setState((p) =>
                p ? { ...p, rewardGold: Number(e.target.value) } : p
              )
            }
            placeholder="기본 골드"
          />
          <input
            ...
            onChange={(e) =>
              setState((p) =>
                p ? { ...p, boundGold: Number(e.target.value) } : p
              )
            }
            placeholder="귀속 골드"
          />
          <input
            ...
            onChange={(e) =>
              setState((p) =>
                p ? { ...p, orderNo: Number(e.target.value) } : p
              )
            }
            placeholder="정렬 순서"
          />
                ...
                setState((p) =>
                  p
                    ? {
                        ...
                        extraRewardCost: e.target.checked
                          ? p.extraRewardCost || 0
                          : 0,
                      }
                    : p
          ...
          <input
            ...
            onChange={(e) =>
              setState((p) =>
                p ? { ...p, extraRewardCost: Number(e.target.value) } : p
              )
            }
          ...
          <label className="label cursor-pointer justify-start gap-2">
            <input
              ...
              onChange={(e) =>
                setState((p) => (p ? { ...p, isActive: e.target.checked } : p))
              }
            />
          ...
          <label className="label cursor-pointer justify-start gap-2">
            <input
              ...
              onChange={(e) =>
                setState((p) =>
                  p ? { ...p, isSingleMode: e.target.checked } : p
                )
              }
            />
